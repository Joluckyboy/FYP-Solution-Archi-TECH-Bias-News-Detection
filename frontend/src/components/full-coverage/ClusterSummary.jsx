        ...
        <div className="lg:col-span-2 rounded-xl border border-slate-200 shadow-sm bg-white h-full overflow-hidden">
            ...
            <div className="p-6 md:p-8">
                ...
                <div className="flex items-center gap-2 mb-5">
                    ...
                    <span className="ml-1 inline-flex items-center gap-1 rounded-full bg-indigo-50 border border-indigo-200 px-2.5 py-0.5 text-xs font-medium text-indigo-600">
                ...
                {/* Disclaimer */}
                <p className="mt-5 text-xs text-slate-400 italic flex items-center gap-1.5">
                    <span>✦</span>
