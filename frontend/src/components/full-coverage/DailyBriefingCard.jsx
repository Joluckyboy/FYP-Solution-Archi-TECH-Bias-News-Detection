        ...
        <div className="lg:col-span-2 relative overflow-hidden rounded-xl border border-slate-200 shadow-sm bg-white h-full">
            ...
            <div className="p-6 md:p-8">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-lg font-bold text-slate-800">Daily Briefing</h3>
                    <span className="ml-1 inline-flex items-center gap-1 rounded-full bg-indigo-50 border border-indigo-200 px-2 py-0.5 text-xs font-medium text-indigo-600">
